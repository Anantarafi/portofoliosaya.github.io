...
const translations = {
    id: {
        ...
        'project-canva2-title': 'Desain Logo',
        'project-canva2-desc': 'Perancangan logo sederhana yang mudah diingat dengan fokus pada bentuk dan keterbacaan di berbagai ukuran.',
        'project-canva3-title': 'Desain PPT',
        'project-canva3-desc': 'Template presentasi bergaya minimalis dengan hierarki visual jelas untuk penyampaian materi yang rapi.',
        'project-canva4-title': 'Travel Website',
        'project-canva4-desc': 'Rancangan visual halaman muka situs travel dengan hero kuat dan call-to-action yang menonjol.',
        'project-canva5-title': 'Streetwear Design',
        ...
        'project-food-desc': 'Aplikasi pemesanan makanan dengan antarmuka yang user-friendly dan navigasi intuitif.',
    ...
    en: {
        ...
        'project-canva2-title': 'Logo Design',
        'project-canva2-desc': 'Simple and memorable logo design focused on shape and readability across various sizes.',
        'project-canva3-title': 'PPT Design',
        'project-canva3-desc': 'Minimalist presentation template with clear visual hierarchy for neat material delivery.',
        'project-canva4-title': 'Travel Website',
        'project-canva4-desc': 'Visual design for travel website homepage with strong hero and prominent call-to-action.',
        'project-canva5-title': 'Streetwear Design',
        ...
        'project-food-title': 'Food Ordering UI/UX',
        'project-food-desc': 'Food ordering app with user-friendly interface and intuitive navigation.',
        'project-car-title': 'Car Modification Website UI/UX',
    ...
    updateLanguage(lang) {
        ...
        document.querySelectorAll('[data-translate]').forEach(el => {
            ...
            if (el.tagName === 'INPUT' || el.tagName === 'TEXTAREA') {
                ...
                // Check if element has highlight span
                if (el.querySelector('.highlight')) {
                    const highlightText = el.querySelector('.highlight').textContent;
                    el.innerHTML = `${value} <span class="highlight">${highlightText}</span>`;
                } else {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('%c🌐 Language System Ready', 'color: #10b981; font-size: 12px;');
});
